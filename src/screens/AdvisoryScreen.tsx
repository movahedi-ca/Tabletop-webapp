...
export const AdvisoryScreen: React.FC = () => {
  ...
  return (
    <div className="w-full bg-[#0B101B] text-[#F8FAFC] pb-24 md:pb-12 px-4 md:px-8 pt-4 md:pt-6 max-w-7xl mx-auto">
      ...
      <div className="bg-gradient-to-r from-[#131D2E] via-[#162238] to-[#1A263B] border border-[#22334D] hover:border-[#00F0FF]/30 rounded-2xl p-6 md:p-8 mb-6 shadow-xl relative overflow-hidden transition-all">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
          <div className="flex items-center gap-5">
            <div className="w-16 h-16 md:w-20 md:h-20 rounded-2xl bg-gradient-to-tr from-[#00F0FF] to-[#6366F1] flex items-center justify-center text-[#001F2B] font-black text-2xl md:text-3xl shadow-lg shrink-0">
              MM
            </div>
            <div>
              <div className="flex items-center gap-2 mb-1">
                <span className="text-[10px] font-black text-[#00F0FF] uppercase tracking-wider bg-[#00F0FF]/10 px-2 py-0.5 rounded border border-[#00F0FF]/30">
                  STRATEGIC ADVISORY
                </span>
              ...
              <span className="text-xs md:text-sm font-bold text-[#38BDF8] block mt-0.5">
          ...
          <div className="flex flex-row md:flex-col gap-2.5 shrink-0">
            <a
              ...
              className="flex-1 md:flex-initial h-11 px-5 bg-[#00F0FF] hover:bg-[#00F0FF]/90 text-[#001F2B] font-extrabold text-xs rounded-xl flex items-center justify-center gap-2 transition-all shadow-md active:scale-[0.99]"
            >
            ...
            <a
              ...
              className="flex-1 md:flex-initial h-11 px-5 bg-[#131D2E] hover:bg-[#1E293B] border border-[#6366F1] text-[#38BDF8] font-bold text-xs rounded-xl flex items-center justify-center gap-2 transition-all"
            >
      ...
      {/* Tab Selector */}
      <div className="bg-[#131D2E] border border-[#22334D] rounded-xl p-1.5 mb-6 max-w-xl flex items-center">
        {tabs.map((tab, idx) => (
          <button
            key={tab}
            type="button"
      ...
      {selectedTab === 0 && (
        <div className="space-y-4 mb-8">
          <div className="mb-4">
            <span className="text-[11px] font-black tracking-widest text-[#00F0FF] uppercase block mb-1">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {MovahediData.services.map((service, idx) => (
              <div
                key={idx}
                className="bg-[#131D2E] border border-[#22334D] hover:border-[#00F0FF]/40 rounded-2xl p-5 shadow-md transition-all flex flex-col justify-between group"
              >
                <div>
                  <div className="flex items-start justify-between gap-2 mb-2">
                    <h3 className="text-base font-bold text-[#F8FAFC] group-hover:text-[#00F0FF] transition-colors">
                      {service.title}
                    </h3>
                    <a
                      href={service.url}
                      target="_blank"
                      rel="noopener noreferrer"
                      className="text-[#00F0FF] hover:text-[#00F0FF]/80 p-1 shrink-0"
                  ...
                  <span className="text-xs font-semibold text-[#38BDF8] block mb-2.5">
                    {service.subtitle}
                  </span>
                ...
                <div>
                  <div className="flex flex-wrap gap-1.5 pt-3 border-t border-[#22334D]">
                    {service.tags.map((tag) => (
                      <span
                        key={tag}
                        className="text-[10px] font-mono px-2 py-0.5 rounded bg-[#0B101B] border border-[#22334D] text-[#94A3B8]"
                      >
                        {tag}
                      </span>
                    ))}
              ...
              >
                <div>
                  <div className="flex items-center justify-between gap-2 mb-2">
                    <span className="text-[10px] font-mono font-bold px-2 py-0.5 rounded bg-[#6366F1]/20 text-[#38BDF8] border border-[#6366F1]/40">
                      {insight.category}
                    </span>
                    <span className="text-[11px] font-mono text-[#64748B]">{insight.readTime}</span>
                  </div>

                  <h3 className="text-base font-bold text-[#F8FAFC] group-hover:text-[#00F0FF] transition-colors mb-2 leading-snug">
                    {insight.title}
                  </h3>
                  ...
                  <div className="bg-[#0B101B] border border-[#22334D] rounded-xl p-3 mb-4 flex items-start gap-2.5">
                    <Lightbulb className="w-4 h-4 text-[#F59E0B] shrink-0 mt-0.5" />
                    <p className="text-xs text-[#F8FAFC] leading-relaxed">
                      <strong className="text-[#F59E0B] font-bold">Key Takeaway: </strong>
                      {insight.keyTakeaway}
                    </p>
                  </div>
                </div>

                <div className="flex justify-end pt-2 border-t border-[#22334D]">
                  <a
                    href={insight.url}
                    target="_blank"
                    rel="noopener noreferrer"
      ...
      {selectedTab === 2 && (
        <div className="mb-8">
          <div className="bg-[#131D2E] border border-[#22334D] rounded-2xl p-6 md:p-8 shadow-xl">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
              ...
              <div className="lg:col-span-6 space-y-4">
                <span className="text-xs font-bold text-[#00F0FF] uppercase tracking-wider block mb-1">
                  Step 1: Breach Characteristics & Impact Factors
                </span>

                {/* Criteria 1: Sensitive Data */}
                <div className="flex items-center justify-between gap-4 p-4 rounded-xl bg-[#0B101B] border border-[#22334D]">
                  <div>
                  ...
                  <label className="relative inline-flex items-center cursor-pointer shrink-0">
                    ...
                    />
                    <div className="w-11 h-6 bg-[#22334D] peer-focus:outline-none rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-[#00F0FF]" />
                  </label>
                </div>
                ...
                {/* Volume of records */}
                <div className="p-4 rounded-xl bg-[#0B101B] border border-[#22334D]">
                  ...
                  <input
                    ...
                    className="w-full h-1.5 bg-[#22334D] rounded-lg appearance-none cursor-pointer accent-[#00F0FF]"
                  />
              ...
              <div className="lg:col-span-6 space-y-4">
                ...
                <div
                  className={`rounded-2xl p-5 border transition-all ${
                    isRroshMet
                      ? 'bg-[#EF4444]/10 border-[#EF4444]/50 shadow-[0_0_20px_rgba(239,68,68,0.15)]'
                ...
                >
                    ...
                    <div>
                      <h4
                        className={`text-sm font-black tracking-wider uppercase ${
                          isRroshMet ? 'text-[#EF4444]' : 'text-[#10B981]'
                        }`}
                      >
                        {isRroshMet
                  ...
                  <div className="space-y-2 pt-2 border-t border-[#22334D]/60 text-xs">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-full h-12 bg-[#00F0FF] hover:bg-[#00F0FF]/90 text-[#001F2B] font-extrabold text-xs rounded-xl flex items-center justify-center gap-2 transition-all shadow-md active:scale-[0.99]"
                >
      ...
      {/* Bottom CTA Card */}
      <div className="bg-gradient-to-br from-[#131D2E] to-[#1E293B] border border-[#00F0FF]/40 rounded-2xl p-6 text-center shadow-xl">
        <Shield className="w-8 h-8 text-[#00F0FF] mx-auto mb-2" />
        ...
        <div className="flex justify-center gap-3">
          <a
            ...
            className="px-6 py-3 bg-[#00F0FF] hover:bg-[#00F0FF]/90 text-[#001F2B] font-extrabold text-xs tracking-wider rounded-xl inline-flex items-center justify-center gap-2 transition-all shadow-md active:scale-[0.99]"
          >
