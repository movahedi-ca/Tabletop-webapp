...
export const HomeScreen: React.FC = () => {
  ...
  return (
    <div className="w-full bg-[#0B101B] text-[#F8FAFC] pb-24 md:pb-12 px-4 md:px-8 pt-4 md:pt-6 max-w-7xl mx-auto">
      ...
      <div className="md:hidden flex items-center justify-between mb-3 border-b border-[#22334D] pb-3">
        <div className="flex items-center gap-2">
          <span className="w-2.5 h-2.5 rounded-full bg-[#00F0FF] shadow-[0_0_8px_#00F0FF]" />
          <span className="text-[10px] font-extrabold tracking-widest text-[#00F0FF]">
            INCIDENT COMMAND SYSTEM
          </span>
        </div>
        <span className="text-[10px] font-mono font-semibold px-2 py-0.5 rounded bg-[#131D2E] text-[#38BDF8] border border-[#22334D]">
          ICS-300 • v2.4.0
        </span>
      </div>
      ...
      <div className="mb-6 md:mb-8 flex flex-col md:flex-row md:items-end md:justify-between gap-4">
        <div>
          <div className="hidden md:flex items-center gap-2 mb-2">
            <span className="text-[11px] font-mono font-bold text-[#00F0FF] tracking-wider uppercase bg-[#00F0FF]/10 px-2 py-0.5 rounded border border-[#00F0FF]/30">
        ...
        <div className="grid grid-cols-3 md:grid-cols-3 gap-2.5 shrink-0">
          <div className="bg-[#131D2E] border border-[#22334D] rounded-xl p-3 min-w-[90px] md:min-w-[110px] text-center">
            <span className="text-[9px] md:text-[10px] font-bold text-[#64748B] uppercase block">
              SCENARIOS
            </span>
            <span className="text-lg md:text-2xl font-black font-mono text-[#00F0FF] mt-0.5 block">
              {allScenarios.length}
            </span>
          ...
          <div className="bg-[#131D2E] border border-[#22334D] rounded-xl p-3 min-w-[90px] md:min-w-[110px] text-center">
            ...
            <span className="text-lg md:text-2xl font-black font-mono text-[#10B981] mt-0.5 block">
              {totalCompleted}
            </span>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8">
        ...
        <div className="lg:col-span-8">
          {/* Search & Filter Bar */}
          <div className="bg-[#131D2E] border border-[#22334D] rounded-2xl p-4 mb-5 shadow-md">
            {/* Search Input */}
            <div className="relative mb-3">
              ...
              <input
                ...
                className="w-full bg-[#0B101B] border border-[#22334D] rounded-xl pl-9 pr-3 py-2.5 text-xs text-[#F8FAFC] placeholder-[#64748B] focus:outline-none focus:border-[#00F0FF]/60 transition-colors"
              />
            </div>
                  ...
                  <button
                    ...
                    className={`px-3 py-1 rounded-lg text-[11px] font-semibold tracking-wide whitespace-nowrap transition-all ${
                      selectedCategory === cat
                        ...
                        : 'bg-[#0B101B] text-[#94A3B8] hover:text-[#F8FAFC] border border-[#22334D]'
                    }`}
                  >
                    {cat}
                  </button>
                    ...
                    className={`px-2.5 py-1 rounded-md text-[10px] font-mono font-bold transition-all ${
                      selectedSeverity === sev
                        ? sev === 'CRITICAL'
                          ...
                          : 'bg-[#00F0FF] text-[#001F2B]'
                        : 'bg-[#0B101B] text-[#64748B] hover:text-[#94A3B8] border border-[#22334D]'
                    }`}
                  >
                    {sev}
                  </button>
          ...
          {filteredScenarios.length === 0 ? (
            <div className="bg-[#131D2E] border border-[#22334D] rounded-2xl p-8 text-center">
              ...
              <button
                ...
                className="px-4 py-2 bg-[#00F0FF] text-[#001F2B] text-xs font-bold rounded-lg"
              >
                Reset Filters
              </button>
            </div>
        ...
        <div className="lg:col-span-4 space-y-5">
          ...
          <div
            ...
            className="bg-gradient-to-br from-[#131D2E] to-[#1A263B] border border-[#6366F1]/50 rounded-2xl p-4 cursor-pointer hover:border-[#00F0FF]/60 transition-all shadow-lg group relative overflow-hidden"
          >
            <div className="absolute top-0 right-0 w-32 h-32 bg-[#6366F1]/10 rounded-full blur-2xl pointer-events-none" />

            <div className="flex items-start justify-between gap-3 mb-2">
              <div className="flex items-center gap-2.5">
                <div className="w-10 h-10 rounded-xl bg-gradient-to-tr from-[#00F0FF]/20 to-[#6366F1]/30 border border-[#00F0FF]/40 flex items-center justify-center text-[#00F0FF] shadow-md shrink-0">
                  <Sparkles className="w-5 h-5 text-[#00F0FF]" />
                </div>
                <div>
                  <span className="text-[9px] font-black text-[#00F0FF] uppercase tracking-wider block">
                    CANADIAN PRIVACY & AI ADVISORY
                  </span>
                  <h4 className="text-sm font-bold text-[#F8FAFC] group-hover:text-[#00F0FF] transition-colors">
                    {MovahediData.CONSULTANT_NAME}
                  </h4>
                </div>
              </div>
              <ChevronRight className="w-4 h-4 text-[#64748B] group-hover:text-[#00F0FF] group-hover:translate-x-1 transition-all mt-1 shrink-0" />
            </div>
            ...
            <div className="flex items-center justify-between pt-2 border-t border-[#22334D]/80 text-[11px]">
              <span className="text-[#38BDF8] font-semibold">RROSH Breach Evaluator</span>
              <span className="text-xs text-[#00F0FF] font-bold flex items-center gap-1">
          ...
          <div className="bg-[#131D2E] border border-[#22334D] rounded-2xl p-4 shadow-md">
            <div className="flex items-center justify-between mb-3">
              ...
              <button
                ...
                className="text-[11px] font-bold text-[#00F0FF] hover:underline flex items-center gap-0.5"
              >
            ...
            <div className="space-y-2.5">
              <div className="p-2.5 rounded-xl bg-[#0B101B] border border-[#22334D] flex items-center justify-between">
                <div>
                ...
                <span className="text-[10px] font-mono font-bold px-2 py-0.5 rounded bg-[#EF4444]/15 border border-[#EF4444]/30 text-[#EF4444]">
                  4 Business Days
                </span>
              </div>
              ...
              <div className="p-2.5 rounded-xl bg-[#0B101B] border border-[#22334D] flex items-center justify-between">
                ...
                <span className="text-[10px] font-mono font-bold px-2 py-0.5 rounded bg-[#00F0FF]/15 border border-[#00F0FF]/30 text-[#00F0FF]">
                  As Soon As Feasible
                </span>
              </div>
            </div>
              ...
              <div className="space-y-2">
                {pastDrills.slice(0, 3).map((drill) => (
                  <div
                    key={drill.id}
                    onClick={() => navigateTo(Screen.HISTORY_LOGS)}
                    className="p-2.5 rounded-xl bg-[#0B101B] border border-[#22334D] hover:border-[#00F0FF]/40 cursor-pointer transition-all flex items-center justify-between"
                  >
                    ...
                    <div className="flex items-center gap-2 shrink-0">
                      ...
                      <span className="w-7 h-7 rounded-lg bg-[#10B981]/15 text-[#10B981] border border-[#10B981]/30 font-mono font-black text-xs flex items-center justify-center">
                        {drill.letterGrade}
                      </span>
                    </div>
                  </div>
