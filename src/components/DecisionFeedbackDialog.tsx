...
export const DecisionFeedbackDialog: React.FC<DecisionFeedbackDialogProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/80 backdrop-blur-sm flex items-center justify-center p-4">
      <div className="w-full max-w-lg bg-[#131D2E] border border-[#00F0FF]/50 rounded-2xl p-5 max-h-[90vh] overflow-y-auto shadow-2xl animate-in fade-in zoom-in-95 duration-200">
        {/* Header badge */}
        <div className="flex items-center gap-3 mb-3.5">
          <div className="w-9 h-9 rounded-lg bg-[#00F0FF]/20 flex items-center justify-center text-[#00F0FF]">
            <CheckSquare className="w-5 h-5" />
          </div>
          <div>
            <span className="text-[10px] font-bold text-[#00F0FF] tracking-wider block">
              ORDER EXECUTED
            </span>
        ...
        {/* Chosen Order Box */}
        <div className="bg-[#0B101B] border border-[#22334D] rounded-lg p-3 mb-3.5">
        ...
        {/* Doctrine Analysis */}
        <div className="mb-4">
          <span className="text-[11px] font-bold text-[#38BDF8] tracking-wide block mb-1.5">
            DOCTRINE & REGULATORY ANALYSIS
          </span>
          <p className="text-xs text-[#94A3B8] leading-relaxed bg-[#0B101B]/50 p-3 rounded-lg border border-[#22334D]/60">
        ...
        <div className="mb-5">
          ...
          <div className="space-y-1.5 bg-[#0B101B] p-3 rounded-lg border border-[#22334D]">
        ...
        <button
          ...
          className="w-full h-12 bg-[#00F0FF] hover:bg-[#00F0FF]/90 text-[#001F2B] font-extrabold text-xs tracking-wider rounded-xl flex items-center justify-center gap-2 transition-all shadow-lg active:scale-[0.99]"
        >
